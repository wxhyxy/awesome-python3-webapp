...
from jinjia2 import Envionment, FileSystemLoader
...
def init_jinjia2(app, **kw):
	...
	env = Envionment(loader = FileSystemLoader(path). **options)
...
async def init(loop):
	...
	app = web.Application(loop=loop, middlewares = [
		...
		app.router.add_route(app, 'handlers')
